...
internal class Awaiter {
    ...
    private func createTimerSource(_ queue: DispatchQueue) -> DispatchSource {
        return DispatchSource.timer(flags: DispatchSource.TimerFlags.strict, queue: queue) /*Migrator FIXME: Use DispatchSourceTimer to avoid the cast*/ as! DispatchSource
    }
